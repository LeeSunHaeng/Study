...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		/*
		 	function : 함수 , 독립적
		 	method : class에 소속된 함수.(언어 안에 , 클래스 내부에서)
		 	
		 	형식 : 
		 										 parameter,인수,인자
		 										 게타(getter)
		 	돌아오는 값의 자료형(return value) 항수명(들어 가는 값의 자료형 변수,들어 가는 값의 자료형 변수,...  ){
		...
		System.out.println("functionName(char) 호출");
		String st = "abcDEF";
	...
	static void functionName1() {
	 ...
	 static int functionName(char c) {
		System.out.println("function(char c) 호출");
		return 1;
	}
