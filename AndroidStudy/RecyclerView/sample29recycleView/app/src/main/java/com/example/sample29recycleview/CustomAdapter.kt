package com.example.sample29recycleview
...
class ItemViewHolder(itemView:View) : RecyclerView.ViewHolder(itemView){
    ...
    private val userName = itemView.findViewById<TextView>(R.id.item_seqText)
    private val userPay = itemView.findViewById<TextView>(R.id.item_titleText)
    private val userAddress = itemView.findViewById<TextView>(R.id.item_dayText)
